...
public class DartVo {
	...
	public DartVo(String corp_code, String corp_name, String stock_code, String corp_cls, String report_nm,
			String rcept_no, String flr_nm, String rcept_dt, String rm, String pblntf_detail_ty ) {
		super();
		...
		this.rm = rm;
		this.pblntf_detail_ty = pblntf_detail_ty;
	}
	...
	public String getBgn_de() {
		return bgn_de;
	}

	public void setBgn_de(String bgn_de) {
		this.bgn_de = bgn_de;
	}
	...
	public String getPblntf_detail_ty() {
		return pblntf_detail_ty;
	}

	public void setPblntf_detail_ty(String pblntf_detail_ty) {
		this.pblntf_detail_ty = pblntf_detail_ty;
	}
